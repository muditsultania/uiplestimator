...
const CategorySubcategoryStyleK = ({ onBack, onSubmit, onPrint, formData, onDelete, onSkip, carpetArea }) => {
  ...
  const categories = [
    ...
    {'name': 'Brick & Masonry Work', 'subcategories': ['Red Bricks', 'AAC Blocks', 'Concrete Blocks', 'Plaster Work', 'WaterProofing', 'Kitchen Platform Base (Masonry, Vertical Support, Tiling Etc.)', 'Dismentalling Of Wall']},
    ...
    {'name': 'Plumbing Work', 'subcategories': ['PVC', 'CPVC', 'Concealed Parts', 'Labour/wct including Installations', 'Taps and Showers', 'Copper']},
    {'name': 'Flooring Solutions', 'subcategories': ['Tiles', 'Marble', 'Italian Marble', 'Granite', 'Kotah Stone', 'Kadappa Stone', 'Vinyl', 'Wooden', 'Floor Polishing']},
    ...
    {'name': 'Ceiling Work', 'subcategories': ['Gypsum/CFG Ceiling', 'Wooden Ceiling', 'POP Ceiling', 'Wooden Ceiling', 'GI Plank Ceiling', 'Hilux (Calcium Silicate) Ceiling', 'Shera Plank And Melamine']} ,
    {'name': 'HVAC System', 'subcategories': ['Copper piping work', 'Electric Cableing', 'Drain Pipe', 'ODU Stand']},
    {'name': 'Paint and Wall Finishes', 'subcategories': ['Oil Based', 'Acrylic', 'POP Puning', 'Wall Paper']},
    {'name': 'Window Treatment', 'subcategories': ['Main Curtains', 'Main + Sheer Curtains', 'Blinds', 'Shades', 'Installation Charges']},  
    {'name': 'Readymade Furniture', 'subcategories': ['Bench - 2 Seater Laminate Finish', 'Swing - 1 Seater', 'Swing - 2 Seater', 'Swing - 3 Seater', 'Sofa - 3 Seater', 'Corner Table', 'Dining Table', 'Console Table', 'Bar Table', 'Bedside table', 'Coffee table', 'Computer table', "Children's table", 'Conference & meeting table', 'Dressing table', 'Multifunctional table', 'Study table', 'Bar chair', 'Bar stool', 'Armchair', 'Wing chair', 'Dining chair', 'Junior dining chair', 'Foot stool (Ottoman)', 'Pouffe', 'Stools', 'Study Chair - Wooden', 'Study Chair - Revolving', 'Garden chair', 'Balcony Chair', 'Office Chair', 'Rocking Chair', 'Recliner Chair', 'Nursery furniture - Baby chairs & high chair', 'Gaming chair', 'Wardrobes - Sliding', 'Wardrobes -  Wardrobes Loft', 'Cloth Organiser - Ducco Finish', 'Aluminium Profile With Glass Shutter - Ducco Finish', 'Outdoor Furniture - Coffee Table', 'Dressing Storage - Veneer In Polish/PU Finish', 'Toy Storage - Paint/Laminate Finish', 'Toy Storage - Ducco Finish', 'Study Storage - Paint/Laminate Finish', 'Wardrobes - Hinged(Openable)', 'Luggage Storage - PU Finish', 'Vanity Cabinet - Veneer In Polish/PU Finish', 'Temple', 'Chest Of Drawer', 'Storage Cabinet - Ducco Finish', 'Dressing Storage - PU Finish', 'Cloth Organiser - PU Finish', 'Aluminium Profile With Glass Shutter - PU Finish', 'Toy Storage - PU Finish', 'Luggage Storage - Ducco Finish', 'Vanity Cabinet - Paint/Laminate Finish', 'Luggage Storage - Veneer In Polish/PU Finish', 'Toy Storage - Veneer In Polish/PU Finish', 'Cloth Organiser - Veneer In Polish/PU Finish', 'Study Storage - Ducco Finish', 'Dressing Storage - Paint/Laminate Finish', 'Vanity Cabinet - Ducco Finish', 'Shoe Rack', 'Bed', 'Aluminium Profile With Glass Shutter- Veneer In Polish/PU Finish', 'Aluminium Profile With Glass Shutter - Paint/Laminate Finish', 'Outdoor Furniture - Chair', 'Book Storage Cabinet', 'Crockery Cabinet -', 'Vanity Cabinet - PU Finish', 'TV Cabinet', 'Storage Cabinet - PU Finish', 'Outdoor Furniture - Movable Table', 'Storage Cabinet - Paint/Laminate Finish', 'Outdoor Furniture - Centre Table', 'Book Storage Cabinet -', 'Dressing Storage - Ducco Finish', 'Study Storage - PU Finish', 'Bar Cabinet -', 'Study Storage - Veneer In Polish/PU Finish', 'Centre Table', 'Storage Cabinet - Veneer In Polish/PU Finish', 'Bench', 'TV Cabinet -', 'Cloth Organiser - Paint/Laminate Finish', 'Outdoor Furniture - Sofa', 'Dressing/Toilet Mirror', 'Outdoor Furniture - Breakfast Trolly', 'Luggage Storage - Paint/Laminate Finish']}
    ,{'name': 'Soft Furnishing', 'subcategories': ['Cushions', 'Rugs', 'Throws', 'Door Mat', 'Bedsheets', 'Pillows', 'Blankets']}
